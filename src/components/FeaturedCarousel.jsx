      ...
      <div className="absolute inset-0 left-0 py-2 pl-3 pr-36 sm:py-3 sm:pl-5 sm:pr-44 md:py-3 md:pl-7 md:pr-52 lg:py-4 lg:pl-9 lg:pr-60 flex flex-col justify-center z-10">
        ...
        <div className="flex flex-col gap-1.5 sm:gap-2 md:gap-2.5">
          ...
          <motion.p
            ...
            className="line-clamp-3 sm:line-clamp-3 md:line-clamp-4 lg:line-clamp-5 font-body-lg text-xs sm:text-sm md:text-base lg:text-lg text-on-surface-variant/80 leading-relaxed text-justify"
          >
          ...
          >
            ...
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 bg-white/10 hover:bg-white/20 border border-white/10 text-white font-bold px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 rounded-lg md:rounded-xl hover:scale-105 active:scale-[0.98] transition-all text-[10px] sm:text-xs md:text-sm lg:text-base cursor-pointer"
            >
