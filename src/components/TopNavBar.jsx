              ...
              {isLoggedIn ? (
                <>
                  ...
                  <div className="px-4 py-2.5 border-b border-white/5">
                    ...
                    {supActive && (
                      <p className="text-[10px] font-bold text-amber-300 mt-1.5">
                  ...
                  <div className="px-2 py-2 border-b border-white/5 mb-1">
                    <button
                      ...
                      className="w-full h-9 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white text-[11px] font-black flex items-center justify-center gap-1.5 transition-all shadow-md active:scale-95 cursor-pointer"
                    >
